  ...
  return (
    <footer className="site-footer" id="contact">
      ...
      <div className="footer-newsletter-wrap">
        <div className="newsletter-card">
          <div className="newsletter-header">
            ...
            <h3 className="newsletter-title">JOIN GOD'S OWN COFFEE CLUB</h3>
          ...
          {isSubscribed ? (
            ...
            <form className="newsletter-form" onSubmit={handleSubscribe}>
              ...
              />
              <button type="submit" className="newsletter-btn" aria-label="Subscribe to Coffee Club">
                <span>JOIN NOW</span>
      ...
      <div className="footer-sub-bar">
        <span>© 2026 GREKO COFFEE. ALL RIGHTS RESERVED.</span>
